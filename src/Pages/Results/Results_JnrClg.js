    ...
    <div className="App text-dark">
      <header className="App-header text-dark">
        <div className="mt-4 p-5 banner_radient text-dark rounded container">
          <h3 className="bg-secondary p-3">Results: Junior College</h3>
          <div className="row">
            <div className="col-md-4 ">
              <Link className="text-decoration-none" to="/results_school">
            ...
            <div className="col-md-4 bg-success">
              <Link className="text-decoration-none" to="/results_jnrClg">
            ...
            <div className="col-md-4">
              <Link className="text-decoration-none" to="/results_degreeClg">
