...
function App() {
  ...
  const HandleTextUpload = async (e) => {
    ...
    daty.push(newText);
    await database.collection("About_Us_JnrClg").doc("About_Us_JnrClg").update(
      {
        texts_array: daty,
      },
      { merge: true }
    ...
    <div className="App text-dark">
      <header className="App-header text-dark">
        <div className="mt-4 p-5 banner_radient text-dark rounded container">
          <h3 className="bg-secondary p-3">About Us: Junior College</h3>
          <div className="row">
